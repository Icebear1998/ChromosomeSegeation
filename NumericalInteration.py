...
result_de = differential_evolution(
    objective_weighted,
    bounds=bounds,
    args=(mu_X_exp12, sigma_X_exp12, mu_X_exp32, sigma_X_exp32, 1.0, 1.0),
    strategy='best1bin',
    maxiter=2000,
    popsize=20,
    tol=1e-7
...
ax[0].hist(experimental_data_wt12, bins=20, density=True, alpha=0.2, color='blue', label='Experimental Data')
...
ax[1].hist(experimental_data_wt32, bins=20, density=True, alpha=0.2, color='blue', label='Experimental Data')
