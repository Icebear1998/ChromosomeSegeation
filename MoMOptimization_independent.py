...
def main():
    ...
    for wt_idx, (wt_nll, wt_params) in enumerate(refined_wt_solutions[:5]):
        n2_wt, N2_wt, k, r21, r23, R21, R23 = wt_params
        ...
        minimizer_kwargs = {
            "method": "L-BFGS-B",
            "args": (data_threshold12, data_threshold32, params_baseline),
        ...
        minimizer_kwargs = {
            "method": "L-BFGS-B",
            "args": (data_degrate12, data_degrate32, params_baseline),
        ...
        minimizer_kwargs = {
            "method": "L-BFGS-B",
            "args": (data_initial12, data_initial32, params_baseline),
            "bounds": N_mutant_bound
        }
