...
if __name__ == "__main__":
    ...
    for i in range(num_simulations):
        simulation = ProteinDegradationSimulation(
            initial_proteins_chromosome1, k1_wt, max_time, n01_wt_list[i])
    ...
    for i in range(num_simulations):
        simulation = ProteinDegradationSimulation(
            initial_proteins_chromosome2, k2_wt, max_time, n02_wt_list[i])
        times, states, seperate_time = simulation.run()
    ...
    for i in range(num_simulations):
        simulation = ProteinDegradationSimulation(
            initial_proteins_chromosome3, k3_wt, max_time, n03_wt_list[i])
        times, states, seperate_time = simulation.run()
    ...
    for i in range(num_simulations):
        simulation = ProteinDegradationSimulation(
            initial_proteins_chromosome2, k2_mut, max_time, n02_mut_list[i])
        times, states, seperate_time = simulation.run()
    ...
    for i in range(num_simulations):
        simulation = ProteinDegradationSimulation(
            initial_proteins_chromosome3, k3_mut, max_time, n03_mut_list[i])
        times, states, seperate_time = simulation.run()
        simulations_chromosome3_mut.append((times, states))
        seperate_times_chromosome3_mut.append(seperate_time)

    delta_t1_list_wt = np.array(
        seperate_times_chromosome1_wt) - np.array(seperate_times_chromosome2_wt)
    delta_t2_list_wt = np.array(
        seperate_times_chromosome3_wt) - np.array(seperate_times_chromosome2_wt)
    delta_t1_list_mut = np.array(
